...
Maintain equivalent English and Polish portfolio pages in `README.md` and `README.pl.md`. Use concise introductions, parallel responsibility bullets and consistent technology names. Use dashes only as bullet markers or within established technical terms. Do not add a comma before coordinating conjunctions such as "and" or "or". Keep current responsibilities in the present tense and completed roles in the past tense.
